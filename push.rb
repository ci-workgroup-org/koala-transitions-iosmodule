...
cmd = "pod lib lint *.podspec --allow-warnings --sources=master,fuzz-productions"
value = system( cmd )

cmd = "pod repo push fuzz-productions *.podspec --allow-warnings --sources=master,fuzz-productions"
value = system( cmd )
